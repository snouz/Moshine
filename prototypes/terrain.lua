  ...
  data:extend({
    ----- Hot swamp
    {
      ...
      water =
      {
        ...
        {
          {
            filename = "__Moshine__/graphics/terrain/sunny-ground-noise-texture.png",
            width = 512,
            height = 512
          },
          {
            filename = "__Moshine__/graphics/terrain/" .. groundtexture .. ".png",
            width = 512 * w,
            height = 512 * h,
            draw_as_glow = false
          }
...
data:extend({
  {
    ...
    variants =
    {
      ...
      material_background =
      {
        picture = "__Moshine__/graphics/terrain/moshine-hot-swamp.png",
        line_length = 8,
        count = 16,
        scale = 0.5
      },
...
data:extend({
  ----------- MOLTEN IRON LAVA
  {
    ...
    water =
    {
      ...
      {
        {
          filename = "__Moshine__/graphics/terrain/moshine-lava-noise-texture.png",
          width = 512,
          height = 512
        },
        {
          filename = "__Moshine__/graphics/terrain/moshine-coastal-lava.png",
          width = 512 * 4,
          height = 512 * 2
        }
      },
  ...
  },
  {
    ...
    variants = tile_variations_template(
      "__Moshine__/graphics/terrain/moshine-coastal-lava2.png",
